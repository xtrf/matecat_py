...
class Body3(object):
    ...
    @property
    def due_date(self):
        """Gets the due_date of this Body3.  # noqa: E501

        Date you want to set as due date. Date must be in the future  # noqa: E501

        :return: The due_date of this Body3.  # noqa: E501
        :rtype: int
        """
    ...
    def due_date(self, due_date):
        """Sets the due_date of this Body3.

        Date you want to set as due date. Date must be in the future  # noqa: E501

        :param due_date: The due_date of this Body3.  # noqa: E501
        :type: int
        """
        if due_date is None:
